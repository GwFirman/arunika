...
export default function LocaleSwitcher() {
  ...
  return (
    <select className='bg-transparent border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange' value={locale} onChange={(e) => switchLocale(e.target.value)}>
